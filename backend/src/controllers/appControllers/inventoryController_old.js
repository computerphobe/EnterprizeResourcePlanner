...
console.log('inventoryController loaded');
...
exports.list = async (req, res) => {
    try {
        ...
        const items = await Inventory.find(query)
            ...
            .lean();
        console.log(`🔍 Fetched ${items.length} items for page ${page} with limit ${limit}`);
        // Add computed fields
        ...
        console.log(`🔍 Fetched ${mappedItems.length} items for page ${page} with limit ${limit}`);
