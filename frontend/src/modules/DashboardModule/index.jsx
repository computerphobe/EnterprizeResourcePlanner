...
import inventoryTable from '../InventoryModule/inventorytable';
        ...
        <div>
          <Row gutter={[32, 32]}>
            <SummaryCard
              ...
              percentageChange={invoiceResult?.percentage_change}
            />
            <SummaryCard
              title={translate('Quote')}
              prefix={translate('This month')}
              ...
              percentageChange={quoteResult?.percentage_change}
            />
            <SummaryCard
              ...
              percentageChange={paymentResult?.percentage_change}
            />
            <SummaryCard
              ...
              percentageChange={invoiceResult?.undue_percentage_change}
            />
            <SummaryCard
              title={translate('Inventory')}
              prefix={translate('Available Stock')}
              isLoading={invoiceLoading}
              data={inventoryTable}
            />  
          </Row>
